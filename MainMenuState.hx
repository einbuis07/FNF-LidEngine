...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			// Fixed Y spacing to prevent overlapping
			var menuItem:FlxSprite = new FlxSprite(80, 40 + (i * 140)); 
	...
	function changeItem(huh:Int = 0)
	{
		...
		// Play sound only after bounds check
		if(huh != 0) FlxG.sound.play(Paths.sound('scrollMenu'));

		// Update camera to follow the mid-point of the button
